...
import com.firecode.springcloudtest.product.common.vo.ProductInfoVO;
import com.firecode.springcloudtest.product.common.vo.ProductVO;
...
import com.firecode.springcloudtest.product.service.utils.ResultVOUtil;
...
public class ProductController {
    ...
    public List<ProductInfoOutput> listForOrder(@RequestBody List<String> productIdList) {
        try {
        	if(null != productIdList && productIdList.size() > 2){
        		Thread.sleep(2000);
        	}
